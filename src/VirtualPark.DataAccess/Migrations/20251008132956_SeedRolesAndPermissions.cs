    ...
    public partial class SeedRolesAndPermissions : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("aaaa1111-1111-1111-1111-111111111111"), "Full system access", "Administrator" },
                    { new Guid("bbbb1111-1111-1111-1111-111111111111"), "Attraction operator", "Operator" },
                    { new Guid("cccc1111-1111-1111-1111-111111111111"), "Regular park visitor", "Visitor" }
                });
