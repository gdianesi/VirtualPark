...
{
    /// <inheritdoc />
    public partial class addPermissionGetHistoryById : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("56565656-2222-1111-1111-111111111120"), "Allows retrieving the visit score history", "GetHistoryById-VisitScores" });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Permissions",
                keyColumn: "Id",
                keyValue: new Guid("56565656-2222-1111-1111-111111111120"));
